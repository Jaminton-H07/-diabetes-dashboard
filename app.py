...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with col_a:
        ...
        fig.update_layout(**plotly_base(240), xaxis=dict(range=[0,60],gridcolor=GRID,title='% de valores faltantes'))
        st.plotly_chart(fig, use_container_width=True)
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with col_b:
        ...
        fig.update_layout(**plotly_base(270), yaxis=dict(range=[0,105],gridcolor=GRID,title='Varianza acumulada (%)'))
        st.plotly_chart(fig, use_container_width=True)
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with col_a:
        ...
        fig = go.Figure(go.Bar(x=list(corr_sorted.values()), y=list(corr_sorted.keys()),
                               ...
                               textposition='outside', textfont=dict(color='#F0F4FF')))
        fig.update_layout(**plotly_base(300), xaxis=dict(range=[0,0.6],gridcolor=GRID,title='Correlación de Pearson'))
        st.plotly_chart(fig, use_container_width=True)
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with col_b:
        ...
        fig.update_layout(**plotly_base(310), barmode='group', yaxis=dict(range=[0,1.05],gridcolor=GRID))
        st.plotly_chart(fig, use_container_width=True)
